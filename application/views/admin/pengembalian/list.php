...
function kembalikan(id) {
    window.location.href = "<?php echo site_url() . '/admin/pengembalian/kembalikan' ?>/"+id;
}
            ...
            <tbody>
                ...
                ?>
                    <tr class="">
                        ...
                        <td align="center">
                            <button type="button" <?php if($v['jenis']=='Dikembalikan') {echo 'disabled';} ?> class="btn btn-success btn-xs" onclick="kembalikan('<?php echo $v['kode_peminjaman'] ?>')">
